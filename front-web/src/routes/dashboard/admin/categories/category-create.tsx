...
import type { CreateCategoryFormData } from "../../../../types/FormType";
...
export default function CategoryCreate() {
  ...
  const onSubmit: SubmitHandler<CreateCategoryFormData> = (data: CreateCategoryFormData) => {
  ...
  useEffect(() => {
    if (fetcher.data?.success) {
      setToast({
        message: t("toast.categoryCreated", { ns: "form" }),
        type: "success",
      });
      reset();
        ...
        <form className="form-container" onSubmit={handleSubmit(onSubmit)}>
          <div className="card">
            <div className="card-header">
              <h2 className="card-title">{t("title.createCategory", { ns: "form" })}</h2>
              <p className="card-description">{t("description.createCategory", { ns: "form" })}</p>
            </div>
